...
wp plugin install ninja-forms ajax-thumbnail-rebuild intuitive-custom-post-order enable-media-replace wp-social-likes wp-retina-2x tinymce-advanced force-strong-passwords wordpress-seo remove-https --activate

# Install plugins but don't activate
wp plugin install akismet social-pug rest-api
